...
const Navbar = () => {
    return (
        <nav>
            <ul>
                <li><NavLink to="/" className={(nav) => (nav.isActive) ? "nav-active" : ""}>guitares & basses</NavLink></li>
                ...
                {/* <li><NavLink to="/basses" className={(nav) => (nav.isActive) ? "nav-active" : ""}>basses</NavLink></li> */}
                <li><NavLink to="/artistes" className={(nav) => (nav.isActive) ? "nav-active" : ""}>artistes</NavLink></li>
                {/* <li><NavLink to="/galerie" className={(nav) => (nav.isActive) ? "nav-active" : ""}>galerie</NavLink></li> */}
