...
import imgLaGiger2 from '../../assets/img/img_0009.jpg';
        ...
        <div className='body'>
            ...
            <div className='bass' id='bass'>
                ...
                <div className='text-container'>
                    <p>Cette basse a été réalisée en collaboration et spécialement conçue pour Rudy Purkart (bassiste du groupe LANDMVRKS).</p>
                    <p>Elle est constituée d’un corps et d’un manche en aluminium aéronautique, ainsi que d’une touche en titane, lui conférant une précision et un claquant uniques.</p>
